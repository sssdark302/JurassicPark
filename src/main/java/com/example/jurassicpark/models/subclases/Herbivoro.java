...
public class Herbivoro extends Dinos {
    public Herbivoro(String especie, int edad, double altura_maxima, int peso_maximo, Sexo sexo,
        ...
        super(especie, edad, altura_maxima, peso_maximo, sexo, hp_maxima, "Herbivoro", faseCicloDeVida, tuvoHijos, alturamaximaOriginal, pesomaximoOriginal, hpmaximaOriginal);
    }
}
