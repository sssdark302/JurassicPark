    ...
    public void verificarReproduccion(Dinosaurio dinosaurio, Dinosaurio dinosaurio2) { //si ambos dinos estan en etapa de repro, misma especie, distinto sexo y no han tenido hijos
        ...
        if (obtenerFase(dinosaurio) == REPRODUCCION
            ...
            if (probabilidadRepro < 29) {
                ...
                String habitatNuevoDino = dinosaurio.getHabitat();
                Dinos nuevoDino = dinosaurioFactory.crearDinosaurio(tipoDino, especieNuevoDino, edadNuevoDino, alturaMaximaNuevoDino,pesoMaximoNuevoDino, sexoNuevoDino, hpMaximaNuevoDino, false, faseCicloDeVidaND, habitatNuevoDino) ;
